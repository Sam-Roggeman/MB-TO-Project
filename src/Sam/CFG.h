...
public:
     ...
     * @param P std::map<from variabel (std:string), producties std::vector<productie std::vector <to variabele/terminal>>>
     * @param S startstate std::string
     */
    CFG(std::vector<std::string>V,std::vector<std::string>T,std::map<std::string,std::vector<std::vector<std::string>>> P,std::string S);
