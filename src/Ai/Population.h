...
//
//        boolean done()
//        { // check if all the cars in the population are crashed/finished
...
//
//        void update()
//        {                              // update all the cars in the generation
//                if (!bestCar.done()) { // if the best car is not done -> update it, this car is a replay of the best
//                                       // from the past
//                        generation bestCar.update();
//                }
//                for (int i = 0; i < cars.size(); i++) {
//                        if (!cars[i].done()) {
//                                cars[i].update();
...
//
//        void setBestCar()
//        { // set the best car of the generation
//                double max = 0;
//                int maxIndex = 0;
//                for (int i = 0; i < cars.size(); i++) {
...
//        void mutate()
//        {
//                for (int i = 1; i < cars.size(); i++) { // start from 1 as to not override the best car placed in index
//                                                        // 0
//                        cars[i].mutate();
//                }
//        }
